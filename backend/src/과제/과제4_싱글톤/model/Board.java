...
/*
 	model 관계
 		...
 		* 양방향 설정 [*toString메소드 사용 불가] : stackOverFlow
 			- 객체호출시 -> 주소값
 			- 스택 영역              vs.               힙영역
		   ...
		   글쓰기 할때 양방향 설정
		   		...
		   		board 호출시 32번지가 가지고 있던 member 33번지 호출
		   		33번지가 가지고 있던 32번지를 다시 호출 -> 
		   		32번지가 33번지를 가지고 있던 33번지.....--->
		   		=> 이런 경우 stackOverFlow가 생김
		   		=> 따라서, 주소를 호출하지말고 주소의 필드값을 출력해야 순환참조문제가 걸리지X
...
public class Board {
	...
	private int view;
	// 하나의 게시물[객체]가 하나의 member 객체를 가질수있다.
