	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			for(FileItem item : fileitemList) {//요청된 모든 매개변수들을 반복문 돌려서 확인
				System.out.println("필드명 : " + item.getFieldName());  //매개변수명 확인
		 ...
		 * System.out.println(dto); boolean result =
		 * ProductDao.getInstance().write(dto); response.getWriter().print(result);
		 */
	}
